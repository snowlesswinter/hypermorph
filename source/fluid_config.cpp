...
FluidConfig::FluidConfig()
    ...
    , temperature_dissipation_(0.95f, "temperature dissipation")
    , velocity_dissipation_(0.999f, "velocity dissipation")
    , density_dissipation_(0.988f, "density dissipation")
