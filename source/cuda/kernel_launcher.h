...
extern void LaunchAdvectVelocityStaggered(cudaArray* fnp1_x, cudaArray* fnp1_y, cudaArray* fnp1_z, cudaArray* fn_x, cudaArray* fn_y, cudaArray* fn_z, cudaArray* aux, cudaArray* vel_x, cudaArray* vel_y, cudaArray* vel_z, float time_step, float dissipation, uint3 volume_size, BlockArrangement* ba, AdvectionMethod method);
